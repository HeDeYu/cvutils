...
When `reporting a bug <http://192.168.16.33/HeDeYu/cvutils/issues>`_ please include:
...
The best way to send feedback is to file an issue at http://192.168.16.33/HeDeYu/cvutils/issues.
...
1. Fork the `cvutils` repo on website.
